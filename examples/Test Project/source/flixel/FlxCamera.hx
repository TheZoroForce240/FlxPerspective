...
class FlxCamera extends FlxBasic
{
	...
	public function drawTriangles(graphic:FlxGraphic, vertices:DrawData<Float>, indices:DrawData<Int>, uvtData:DrawData<Float>, ?colors:DrawData<Int>,
			...
			?cullingMode:TriangleCulling = TriangleCulling.NONE, ?cameraBounds:FlxRect = null):Void
	{
		if (FlxG.renderBlit)
		{
			if (position == null)
			...
			else
			{
				...
				trianglesSprite.graphics.drawTriangles(drawVertices, indices, uvtData, cullingMode);
		...
		else
		{
			...
			drawItem.addTriangles(vertices, indices, uvtData, colors, position, _bounds, transform, cullingMode);
			#else
